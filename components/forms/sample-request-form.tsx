  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div>
          <label htmlFor="sr-name" className="block text-sm font-medium text-text mb-1.5">
            Name *
          </label>
          <input
            id="sr-name"
        ...
        <div>
          <label htmlFor="sr-email" className="block text-sm font-medium text-text mb-1.5">
            Email *
          </label>
          <input
            id="sr-email"
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div>
          <label htmlFor="sr-phone" className="block text-sm font-medium text-text mb-1.5">
            Phone *
          </label>
          <input
            id="sr-phone"
        ...
        <div>
          <label htmlFor="sr-company" className="block text-sm font-medium text-text mb-1.5">
            Company *
          </label>
          <input
            id="sr-company"
      ...
      <div>
        <label htmlFor="sr-role" className="block text-sm font-medium text-text mb-1.5">
          Role / Title
        </label>
        <input
          id="sr-role"
        ...
        <div>
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2 text-sm text-text-muted">
              <input type="checkbox" value="glass" {...register("product_interest")} className="rounded border-border" />
              Glass Collection
            </label>
            <label className="flex items-center gap-2 text-sm text-text-muted">
              <input type="checkbox" value="pet" {...register("product_interest")} className="rounded border-border" />
              PET Collection
            </label>
          </div>
          {errors.product_interest && (
            <p className="mt-1 text-xs text-red-600">{errors.product_interest.message}</p>
          )}
        </div>

        <div>
          <label htmlFor="sr-quantity" className="block text-sm font-medium text-text mb-1.5">
            Quantity *
          </label>
          <select
            id="sr-quantity"
      ...
      <div>
        <label htmlFor="sr-address" className="block text-sm font-medium text-text mb-1.5">
          Shipping Address *
        </label>
        <textarea
          id="sr-address"
        ...
        {errors.shipping_address && (
          <p className="mt-1 text-xs text-red-600">{errors.shipping_address.message}</p>
        )}
      </div>

      <div>
        <label htmlFor="sr-reason" className="block text-sm font-medium text-text mb-1.5">
          Reason for Request *
        </label>
        <textarea
          id="sr-reason"
