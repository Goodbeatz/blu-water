  ...
  if (status === "success") {
    return (
      <div className="text-center py-12">
        <h3 className="text-2xl font-light text-text">Application Received</h3>
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div>
          <label htmlFor="ta-business" className="block text-sm font-medium text-text mb-1.5">
            Business Name *
          </label>
          <input
            id="ta-business"
        ...
        <div>
          <label htmlFor="ta-contact" className="block text-sm font-medium text-text mb-1.5">
            Contact Name *
          </label>
          <input
            id="ta-contact"
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div>
          <label htmlFor="ta-email" className="block text-sm font-medium text-text mb-1.5">
            Email *
          </label>
          <input
            id="ta-email"
        ...
        <div>
          <label htmlFor="ta-phone" className="block text-sm font-medium text-text mb-1.5">
            Phone *
          </label>
          <input
            id="ta-phone"
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div>
          <label htmlFor="ta-type" className="block text-sm font-medium text-text mb-1.5">
            Business Type *
          </label>
          <select
            id="ta-type"
        ...
        <div>
          <label htmlFor="ta-volume" className="block text-sm font-medium text-text mb-1.5">
          ...
          {errors.estimated_volume && <p className="mt-1 text-xs text-red-600">{errors.estimated_volume.message}</p>}
        </div>
      </div>

      <div>
        <label htmlFor="ta-tax" className="block text-sm font-medium text-text mb-1.5">
      ...
      <div>
        <label htmlFor="ta-address" className="block text-sm font-medium text-text mb-1.5">
          Shipping Address *
        </label>
        <textarea
          id="ta-address"
        ...
        />
        {errors.shipping_address && <p className="mt-1 text-xs text-red-600">{errors.shipping_address.message}</p>}
      </div>

      <div>
        <label htmlFor="ta-message" className="block text-sm font-medium text-text mb-1.5">
